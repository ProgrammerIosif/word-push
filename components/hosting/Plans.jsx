      ...
      <div className='mt-20 grid bg-transparent max-md:max-w-sm md:grid-cols-3 max-xl:w-[800px] gap-y-16 bg-white text-black rounded-lg'>
        {plans.map((plan,idx) =>
          <div className='flex flex-col p-5 basis-full bg-white'>
            ...
            <Link href='/start' className='button sticky top-2 font-medium bg-[#101517] text-white h-10 rounded-md my-4 text-sm flex items-center justify-center'>Get {plan.name}</Link>
        ...
        <div className='flex flex-col p-5 basis-full bg-[#101517] text-white rounded-r-lg'>
          ...
          <Link href="/start" className='button sticky top-2 font-medium bg-white text-black h-10 rounded-md my-4 text-sm flex items-center justify-center'>Get in touch</Link>
