...
function Nav() {
  ...
  return (
    <nav>
      ...
      <div className={`${dropdownVisibility ? '' : 'scale-0 scale'} z-10 lg:hidden origin-top-right ease-in-out duration-500 transition-all w-[400px] max-sm:w-[calc(100vw-1rem)] md:w-[480px] absolute bg-white right-2 top-3 py-5 rounded-xl  shadow-dropdown`}>
