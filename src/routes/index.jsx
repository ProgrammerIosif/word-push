  ...
  return (
    <>
      ...
      <section className='bg-[#101517] my-[-15rem] flex justify-center'>
        <div className="pt-60 w-full max-w-[1400px] max-xl:px-5">
          ...
          <div className="mt-52 w-full max-w-6xl my-10  mx-auto text-white">
            <h2 className="font-serif text-7xl"><span className="">Build anything with</span><br /><span>WordPress.com</span></h2>
      ...
      <section className='mt-60 bg-white -mb-60'>
        <div className="pt-32 w-full max-w-6xl max-xl:px-5 mx-auto">
            <h2 className="font-serif text-7xl">Infinitely efortless editing</h2>
      ...
      <section className=' bg-[#bbe0fa] pt-60 -mb-14'>
        <div className="pt-32 w-full max-w-6xl max-xl:px-5 mx-auto">
            <h2 className="font-serif text-7xl">Your home on the web</h2>
            ...
            <SearchBar classes={'text-3xl h-28'}/>
        </div>
      </section>
      <section className='bg-[#e9eff5] pb-28'>
        <div className="pt-60 w-full max-w-6xl max-xl:px-5 mx-auto">
            <h2 className="font-serif text-7xl max-w-5xl">Basically, the best managed WordPress hosting on the planet.</h2>
      ...
      <section className='bg-white mb-28'>
        <div className="pt-60 w-full max-w-[1500px] max-xl:px-5 mx-auto flex flex-col items-center">
            <h2 className="font-serif text-5xl max-w-5xl mb-5">Choose your flavor of WordPush</h2>
            <Plans/>
        </div>
      </section>
      <section className='bg-[#e9eff5] pt-36 pb-24'>
        <div className="w-full max-w-6xl max-xl:px-5 mx-auto">
            <h2 className="font-serif text-6xl max-w-5xl">You'll never build alone</h2>
            ...
            <div className='grid grid-cols-2 pt-16 gap-6'>
              <div>
                ...
                <h3 className='font-serif text-5xl my-5'>Real support</h3>
              ...
              <div>
                ...
                <h3 className='font-serif text-5xl my-5'>Website design service</h3>
