    ...
    <>
      <div className="bg-gradient-to-b from-[#0b4f7b] to-[#101517] text-white">
        ...
        <div className="pt-24 w-full max-w-4xl max-xl:px-5 mx-auto pb-20">
          ...
          <p className="text-lg font-normal mt-6">Whatever you need. Whatever you’re trying to get done.<br/>There’s a feature for that on WordPress.com.</p>
      ...
      <div className='bg-[#101517] text-white'>
        {features.map(section => 
          <div className='w-full max-w-4xl max-xl:px-5 mx-auto py-10'>
            ...
            <button className='w-80 h-12 border border-opacity-40 border-[#007cba] my-20 rounded hover:underline'>{section.button}</button>
          </div>)}
        <h2 className='w-full max-w-4xl max-xl:px-5 mx-auto text-5xl font-serif'>What other builders are saying</h2>
        <div className='py-16 overflow-x-scroll'>
          <div className='max-w-4xl m-auto max-xl:px-5'>
            <div className='grid grid-cols-[repeat(6_,min(70vw_,566px))] w-fit'>
              {[
                {
