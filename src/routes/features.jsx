...
function Features() {
  return (
    <div className="bg-[#101517] text-white">
              ...
              {section.cards.map(card => 
                <div className="bg-[#2c3338] text-white rounded-lg p-7">
                  <div className="h-9 w-9 bg-black p-1.5 rounded-full">
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" className="">
      ...
      <div className="py-40 bg-[url(https://wpcom.files.wordpress.com/2023/02/mesh-blue-2.png)] bg-cover">
        <div className="w-full max-w-6xl max-xl:px-5 mx-auto">
          <h1 className="font-serif text-6xl">Have it all.</h1>
          <p className="max-w-4xl text-lg font-normal mt-4">Beauty. Speed. Simplicity. And the power to grow.<br/>You don’t need to choose.</p>
