  ...
  return (
    <>
        ...
        <div className="py-24 w-full max-w-6xl max-xl:px-5 mx-auto">
          <div className='flex justify-between mb-10'>
            <div className="flex flex-col justify-center">
              <h1 className="font-serif text-6xl text-[#055d9c]">Great ideas start with a good domain name</h1>
      ...
      <section className='bg-[#008763] text-white'>
        <div className='py-24 w-full max-w-6xl max-xl:px-5 mx-auto'>
          <div className='grid grid-cols-2 gap-24'>
            <div className='flex flex-col justify-center'>
              <h2 className="text-6xl font-serif mb-5">Your domain.<br/> Your identity.</h2>
            ...
            <div className='w-full border border-white rounded-xl flex justify-center'>
              <img width='427' height='359' src="https://wpcom.files.wordpress.com/2021/12/wine-mockups.png" alt="" />
            </div>
            <div className='flex flex-col justify-center'>
              <h2 className='text-6xl font-serif mb-5'>Get started now.</h2>
              <p>Grab your domain name now so you don’t have to compromise later. Your domain is the starting step to a strong brand.</p>
            </div>
          </div>
          <div className="grid grid-cols-3 gap-20 text-white mb-14 mt-60">
      ...
      <section className='text-[#2c3338]'>
        <div className="pt-24 pb-32 w-full max-w-6xl max-xl:px-5 mx-auto">
          <h2 className="font-serif text-6xl pb-20">Supercharge your domain.</h2>
          ...
          <img className="max-w-5xl rounded-xl pt-24" src="https://wpcom.files.wordpress.com/2021/12/l-calypso-management-view-1.jpg" alt="" />
      ...
      <section className='bg-[#e9f0f5]'>
        <div className="py-24 w-full max-w-6xl max-xl:px-5 mx-auto">
          <h2 className="font-serif text-6xl font-light text-[#2c3338]">Get more with your domain.</h2>
          <p className='bg-[#044b7a] w-max text-white text-sm py-1 px-4 mt-8 rounded'>Included for free with your domain</p>
          <div className="grid grid-cols-3 py-16 gap-24">
