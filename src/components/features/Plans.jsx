      ...
      <div className='mt-20 grid grid-cols-3 max-xl:w-[800px] gap-y-16 bg-white text-black rounded-lg'>
        {plans.map((plan,idx) => 
          <div className='flex flex-col p-5 basis-full'>
            ...
            <button  className='sticky top-2 font-medium bg-[#101517] text-white h-10 rounded-md my-4 text-sm'>Get {plan.name}</button>
        ...
        <div className='flex flex-col p-5 basis-full bg-[#101517] text-white rounded-r-lg'>
          ...
          <button  className='sticky top-2 font-medium bg-white text-black h-10 rounded-md my-4 text-sm'>Get in touch</button>
