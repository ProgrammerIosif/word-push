            ...
            <div className="px-5">
              ...
              <ul className="grid grid-cols-2">
                {category.links.map(item =>
                  <Link to={item.link} className="max-md:text-sm text-[#055d9c] font-semibold my-1">
                    {item.name}
                  </Link>)}
              </ul>
            </div>
