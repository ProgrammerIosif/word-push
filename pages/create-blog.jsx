    ...
    <>
      ...
      <section className="bg-white -mt-60">
        <div className="pt-64 md:pt-80 section">
          ...
          <div className="flex gap-5">
            <Link href='/start'><button className="mt-10 bg-[#101517] text-white flex justify-center items-center w-40 h-14 rounded-md">Start blogging</button></Link>
          </div>
      ...
      <section className="bg-[#f6f7f7]">
        <div className="pt-16 md:pt-32 w-full section">
          ...
          <div className="flex gap-5">
            <Link href="/start"><button className="mt-10 bg-black text-white flex justify-center items-center w-40 h-14 rounded-md">Start writing</button></Link>
          </div>
          <div className="mb-32 grid grid-cols-1 gap-y-12 gap-x-20 mt-12 md:mt-24
            ...
            },
            {
              ...
              img: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path  fillRule="evenodd" d="M6.863 13.644L5 13.25h-.5a.5.5 0 01-.5-.5v-3a.5.5 0 01.5-.5H5L18 6.5h2V16h-2l-3.854-.815.026.008a3.75 3.75 0 01-7.31-1.549zm1.477.313a2.251 2.251 0 004.356.921l-4.356-.921zm-2.84-3.28L18.157 8h.343v6.5h-.343L5.5 11.823v-1.146z" clip-rule="evenodd"></path></svg>,
            ...
            },
            {
              ...
              img: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path  fillRule="evenodd" d="M5.5 9.5v-2h13v2h-13zm0 3v4h13v-4h-13zM4 7a1 1 0 011-1h14a1 1 0 011 1v10a1 1 0 01-1 1H5a1 1 0 01-1-1V7z" clip-rule="evenodd"></path></svg>,
      ...
      <section className="bg-[#055d9c] text-white">
        <div className="py-32 section max-lg:max-w-lg relative">
          ...
          <div className="relative lg:left-1/2 lg:ml-20 lg:w-2/5">
            ...
            <Link href="/start"><button className="bg-white text-[#055d9c] p-3 rounded mt-5">Start blogging.</button></Link>
          </div>
        </div>
      </section>
      <Footer/>
