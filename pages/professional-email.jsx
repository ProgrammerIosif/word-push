    ...
    <>
      ...
      <section>
        <div className="py-5 md:py-24 section md:flex justify-between">
          <div className="flex flex-col justify-center">
            ...
            <Link href="/start"><button className="my-5 bg-[#0675c4] text-white flex justify-center items-center w-40 h-12 rounded-md">Start your free trial</button></Link>
      ...
      <section className="bg-[#008763] text-white">
        <div className="py-24 section flex flex-col items-center">
          ...
          <Link href="/start"><button className="my-5 bg-[#f5e6b3] text-black flex justify-center items-center w-40 h-12 rounded-md">Get started</button></Link>
      ...
      <section>
        <div className="py-24 section text-[#055d9c] flex flex-col items-center">
          ...
          <Link href="/start"><button className="mt-20 bg-sky-600 text-white w-32 h-12">Let's go!</button></Link>
        </div>
      </section>
        ...
        <div className="py-12 md:py-32 section">
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-32 text-lg mt-16">
            ...
            <div>
              ...
              <Link href="/domains"><p className="mt-4 font-semibold underline">Find your domain {'>'}</p></Link>
            </div>
          </div>
        </div>
      </section>
