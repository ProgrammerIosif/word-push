  ...
  return (
    <>
      ...
      <div className="section mb-10">
        <h1 className="small-title text-center mt-20 mb-6 max-w-xl mx-auto">Log in to your account</h1>
        <div className="flex justify-center items-center mt-10 gap-10 flex-col">
          <form className="flex flex-col max-w-sm text-black/90 text-sm font-normal">
            <label for="email">Email Address or Username</label>
            <input type="text" name="email" className="h-10 border rounded border-black/30 mt-2 mb-4 p-3"/>
            <p className="text-black/50">By continuing with any of the options below, you agree to our <span className="text-blue-600 underline hover:text-purple-800 hover:cursor-pointer">Terms of Service</span> and have read our <span className="text-blue-600 underline hover:text-purple-800 hover:cursor-pointer">Privacy Policy</span>.</p>
            <button className="mt-10 text-white bg-[#117ac9] py-3 font-semibold">Continue</button>
          </form>
          <div className="border h-0.5 max-w-sm w-full flex items-center justify-center">
          <p className="h-12 w-12 bg-white flex items-center justify-center text-black/60 text-sm">
            OR
          </p>
          </div>
          <div className="max-w-sm text-sm text-black/80 my-auto">
            ...
            <Link href='/start'>
              <button className="mt-10 border border-black/50 rounded w-full py-3 font-semibold">Create a new account</button>
            </Link>
          </div>
        </div>
      </div>
