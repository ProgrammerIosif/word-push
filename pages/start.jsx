  ...
  return (
    <>
      ...
      <div className="section mb-10">
        <h1 className="small-title text-center mt-20 md:mt-40 mb-6">Let's get started!</h1>
        <h2 className="text-center text-lg text-black/70">First, create your WordPress.com account. Have an account? <Link href='/log-in' className="text-black underline">Log in</Link></h2>
