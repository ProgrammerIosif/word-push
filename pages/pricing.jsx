    ...
    <>
      ...
      <section className="bg-[#1b2224] text-white">
        <div className="py-20 section flex gap-10 justify-between max-md:flex-col">
          <div>
            ...
            <Link href="/start"><button className="mt-6 py-3 px-5 border rounded border-white">Get started</button></Link>
          </div>
      ...
      <section className="bg-[#e9eff5] -mt-56 md:-mt-[500px]">
        <div className="pt-40 md:pt-[480px] section">
          ...
          <Link href="/start"><button className="mt-6 bg-black py-3 px-6 rounded text-white">Build your site</button></Link>
      ...
      <section>
        <div className="section py-20">
          ...
          <Link href="/start"><button className="mt-6 bg-black py-3 px-6 rounded text-white">Start your site</button></Link>
