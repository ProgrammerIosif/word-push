    ...
    <section className='bg-[#101517] -my-20 sm:-my-60 flex justify-center'>
        <div className="pt-36 md:pt-60 w-full max-w-[1400px] max-xl:px-5">
          <div className="mb-20 sm:mb-60 sm:pt-[180px] w-full max-w-6xl mx-auto text-white">
            ...
            <Link href="/started"><button className="mt-10 bg-white text-black font-medium flex justify-center items-center w-48 h-12 rounded-sm" href="/start">Find your theme</button></Link>
          </div>
          <ImageGrid/>
      ...
      <section className='mt-20 bg-white -mb-60'>
        <div className="pt-20 md:pt-32 w-full max-w-6xl max-xl:px-5 mx-auto">
            ...
            <Link href="/start"><button className="mt-10 bg-black text-white flex justify-center items-center w-40 h-14 rounded-md font-medium">Start creating</button></Link>
      ...
      <section className='bg-[#bbe0fa] pt-40 -mb-10 sm:-mb-14'>
        <div className="pt-20 md:pt-32 w-full max-w-6xl max-xl:px-5 mx-auto">
            ...
            <Link href="/domains"><button className="my-12 bg-black text-white flex justify-center items-center w-48 h-12 rounded-md font-medium">Find your domain</button></Link>
      ...
      <section className='bg-[#e9eff5] pb-28'>
        <div className="pt-36 sm:pt-60 w-full max-w-6xl max-xl:px-5 mx-auto">
            ...
            <Link href="/hosting"><button className="mt-12 bg-[#0675c4] text-white flex justify-center items-center w-48 h-12 rounded-md font-medium mb-24">Explore hosting</button></Link>
            <Cards/>
        </div>
      </section>
        ...
        <div className="w-full max-w-6xl max-xl:px-5 mx-auto">
            ...
            <div className='grid sm:grid-cols-2 pt-16 gap-x-6 gap-y-16'>
              <div>
                ...
                <Link href="/start"><button className='mt-6 bg-[#0675c4] text-white flex justify-center items-center w-32 h-12 rounded-md font-medium'>Get started</button></Link>
              </div>
              <div>
      ...
      <section className='bg-[#101517] pt-28 pb-16'>
        <div className="w-full section flex text-white gap-32">
          <div className='lg:max-w-md'>
            ...
            <Link href="/start"><button className='mt-10 bg-[#0675c4] text-white flex justify-center items-center w-32 h-12 rounded-md font-medium'>Get a demo</button></Link>
          </div>
