    ...
    <>
      <section className="bg-[#055d9c] text-white relative">
        ...
        <div className="py-12 md:py-32 section">
          <div className="relative">
            ...
            <Link href="/start"><button className='bg-[#c9356e] py-3 px-5 rounded'>Create your logo now</button></Link>
          </div>
        </div>
      ...
      <section>
        <div className='py-16 md:py-32 section text-lg flex flex-col items-center'>
          ...
          <Link href="/start"><button className='py-3 px-6 bg-[#0675c4] text-white mt-8 font-bold rounded'>Create your logo now</button></Link>
        </div>
      </section>
      <Footer/>
    </>
