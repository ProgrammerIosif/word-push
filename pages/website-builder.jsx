    ...
    <>
      <section className='text-white'>
        ...
        <div className="py-6 md:py-24 max-w-3xl max-xl:px-5 mx-auto grid place-items-center">
          ...
          <Link href="/start"><button className='bg-[#c9356e] py-3 px-4 rounded mt-6 mb-10'>Start your website</button></Link>
        </div>
      </section>
      <section className='text-[#055d9c] bg-white'>
        <div className="py-16 md:py-24 section">
          ...
          <div className='grid place-items-center'>
            <Link href="/start"><button className='mt-8 md:mt-20 bg-[#0675c4] text-white py-2.5 px-4 rounded'>Start your website</button></Link>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#055d9c] text-white">
        <div className="py-12 md:py-32 section relative">
          <div className="relative">
            ...
            <Link href="/start"><button className='bg-[#c9356e] py-2.5 px-4 text-sm rounded'>Start your website</button></Link>
          </div>
          <div className="bg-[url('https://s1.wp.com/wp-content/themes/h4/assets/logo-outlines/720.svg')] invert bg-no-repeat bg-right opacity-20 absolute -right-40 top-0 h-full w-[720px]"></div>
        </div>
      </section>
      ...
      <section className='bg-[#055d9c] text-white'>
        <div className="py-20 md:py-32 section flex flex-col items-center">
          ...
          <Link href="/start"><button className='bg-[#c9356e] rounded py-2.5 px-4 mt-8'>Start your website</button></Link>
        </div>
      </section>
      <section>
        <div className="py-16 md:py-32 section flex flex-col items-center">
          ...
          <Link href="/start"><button className='bg-[#0675c4] text-white rounded py-2.5 px-4 mt-8'>Start your website</button></Link>
        </div>
      </section>
      <section className='text-white'>
        <div className='absolute -z-10 w-full h-full bg-[#055d9c]'>
